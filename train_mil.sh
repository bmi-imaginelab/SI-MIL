...
run_script() {	
	...
	# SI-MIL (ours)
    python train.py  --torch_seed -1  --dataset_split_path 'train_5x_dict.pickle' --dataset_split_path_test 'test_5x_dict.pickle'   --dataset_split_deep_path 'train_5x_dict_dino.pickle' --dataset_split_deep_path_test 'test_5x_dict_dino.pickle' --features_deep_path 'trainfeat_dino.pth'  --features_deep_path_test 'testfeat_dino.pth' --features_path 'binned_hcf.csv' --save_path '/MIL_experiment/ABMIL' --dropout_patch $1 --num_epochs $2 --weight_decay $3 --lr $4 --top_k $6  --organ '' --gpu_index 1    --use_additive 'yes'  --dropout_node $5  --no_projection 'yes'   --feat_type 'patchattn_with_featattn_mlpmixer_Lmse'  --stop_gradient 'no'  --cross_val_fold $7 --temperature 3.0	 &
    ...
    python train.py  --torch_seed -1  --dataset_split_path 'train_5x_dict.pickle' --dataset_split_path_test 'test_5x_dict.pickle'   --dataset_split_deep_path 'train_5x_dict_dino.pickle' --dataset_split_deep_path_test 'test_5x_dict_dino.pickle' --features_deep_path 'trainfeat_dino.pth'  --features_deep_path_test 'testfeat_dino.pth' --features_path 'binned_hcf.csv' --save_path '/MIL_experiment/ABMIL' --dropout_patch $1 --num_epochs $2 --weight_decay $3 --lr $4 --top_k $6  --organ '' --gpu_index 1    --use_additive 'yes'  --dropout_node $5  --no_projection 'yes'   --feat_type 'patchattn_with_featattn_mlpmixer'  --stop_gradient 'no'  --cross_val_fold $7 --temperature 3.0	 &
